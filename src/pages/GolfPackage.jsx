...
const GolfPackage = () => {
  return (
    <main className='blog HomeSchedule'>
            <title>3박5일 세부황제골프패키지포함사항/일정 | 세부밤문화투어</title>  
            ...
            <meta property="og:title" content="3박5일 세부황제골프패키지포함사항/일정 | 세부밤문화투어" />
        ...
        <meta property="og:image" content="https://www.cebunightguide.com/og-image.jpg" />
            <link rel="canonical" href="https://www.cebunightguide.com/golf/cebu-emperor-golf-package-details-schedule" />
