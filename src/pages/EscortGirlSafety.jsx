  ...
  return (
    <main className='blog safety'>
        ...
        <meta property="og:image" content="https://www.cebunightguide.com/og-image.jpg" />
            <link rel="canonical" href="https://www.cebunightguide.com/escort/is-the-philippines-safe-to-visit" />
        ...
        <div className="container">
          ...
          <ContextImageSection
            context={`
              필리핀에서 사고를 당하는 한국 분들을 보
              [r]대부분 카지노 쪽이나 환전을 하시는 분들이 대부분이
              [r]한국인 피살은 금전관계 등으로 인한 청부나 치정 살인 
              [r]앙헬레스나 클락 마닐라 등 한인 지역이나 대도시에서 발
              장기 체류자가 주 피해자이고, 단기 여행자가 범죄에 노출된 일
              굉장히 드물다고 보시면 되세요
            `}
            image={{
              src: "safety2.jpg",
          ...
          <ContextImageSection
            context={`
              성수기에 세부행 비행기가 좌석이 없어서 못 탈 정도로
              한국인 분들이 많이 가시는 반면
              그런 사고 뉴스가 없다시피 한 거 보면 일단 안전은
              인증된 거나 마찬가지인 거 같습니다
            `}
            image={{
              src: "safety3.gif",
          ...
          <ContextImageSection
            context={`
              생활이 궁핍하고 사는 환경이 힘들어도
              항상 얼굴에 미소를 머금고 있는 필리핀 세부 사람들을
              보고 있으면 저도 같이 얼굴에 웃음이 띄며
              유머스러운 상황도 자연스럽게 연출될 만큼
              분위기가 좋은? 곳이 세부랍니다^^
            `}
            image={{
              src: "safety4.jpg",
              alt: "kids on shore swimming"
            }}
          />
          <ContextImageSection
            context={`
...
export default EscortGirlSafety