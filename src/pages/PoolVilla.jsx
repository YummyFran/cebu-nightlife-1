...
const PoolVilla = () => {
  ...
  return (
    <main>
      ...
      <link rel="canonical" href="https://www.cebunightguide.com/poolvilla" />

      <div className="container">
        <h1 className='heading'>세부황제패키지 & 세부풀빌라패키지</h1>
