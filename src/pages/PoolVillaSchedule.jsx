...
const PoolVillaSchdule= () => {
  return (
    <main className='blog schedule'>
        <title>3박5일 풀빌라 패키지&황제투어 4인기준 포함사항 & 일정표| 세부밤문화투어</title>  
        ...
        <meta property="og:title" content="3박5일 풀빌라 패키지&황제투어 4인기준 포함사항 & 일정표 | 세부밤문화투어" />
        ...
        <link rel="canonical" href="https://www.cebunightguide.com/poolvilla/schedule" />
